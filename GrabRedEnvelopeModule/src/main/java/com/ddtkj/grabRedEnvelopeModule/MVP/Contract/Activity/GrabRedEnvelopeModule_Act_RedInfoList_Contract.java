 ...
 */
public interface GrabRedEnvelopeModule_Act_RedInfoList_Contract {
    ...
    interface View extends Common_BaseView {
         ...
         */
        void setInvestmentProductData(List<GrabRedEnvelopeModule_Bean_RedInfoListInfo> investmentProductData);
