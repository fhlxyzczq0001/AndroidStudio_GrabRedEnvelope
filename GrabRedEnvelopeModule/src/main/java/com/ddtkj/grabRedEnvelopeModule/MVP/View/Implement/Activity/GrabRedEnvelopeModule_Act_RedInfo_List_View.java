...
import com.ddtkj.grabRedEnvelopeModule.Adapter.GrabRedEnvelopeModule_Adapter_Act_RedInfoList;
...
import com.ddtkj.grabRedEnvelopeModule.MVP.Presenter.Implement.Activity.GrabRedEnvelopeModule_Act_RedInfo_List_Presenter;
 ...
 */
@Route(Common_RouterUrl.GRAB_RED_ENVELOPE_RedInfoListRouterUrl)
public class GrabRedEnvelopeModule_Act_RedInfo_List_View extends GrabRedEnvelopeModule_BaseActivity<GrabRedEnvelopeModule_Act_RedInfoList_Contract.Presenter,
        GrabRedEnvelopeModule_Act_RedInfo_List_Presenter> implements GrabRedEnvelopeModule_Act_RedInfoList_Contract.View  {
    //刷新布局
    ...
    protected void setContentView() {
        setContentView(R.layout.grabredenvelopemodule_act_redinfo_list_layout);
    }
     ...
     */
    @Override
    public void setInvestmentProductData(List<GrabRedEnvelopeModule_Bean_RedInfoListInfo> investmentProductData){
        //设置Adapter
        if (mVentureCapital2AdapterFraInvestmentList == null) {
            mVentureCapital2AdapterFraInvestmentList = new GrabRedEnvelopeModule_Adapter_Act_RedInfoList(context,investmentProductData);
