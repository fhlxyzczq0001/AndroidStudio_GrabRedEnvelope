 ...
 */
public interface GrabRedEnvelopeModule_Act_Announcement_List_Contract {
    ...
    interface View extends Common_BaseView {
         ...
         */
        void setInvestmentProductData(List<GrabRedEnvelopeModule_Bean_Announcement> investmentProductData);
