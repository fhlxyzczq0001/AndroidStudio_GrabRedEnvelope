 ...
 */
public class GrabRedEnvelopeModule_Act_Rule_List_Presenter extends GrabRedEnvelopeModule_Act_Rule_List_Contract.Presenter{
    ...
    public GrabRedEnvelopeModule_Act_Rule_List_Presenter(){
    ...
    public void requestInvestmentProductData(String type) {
        ...
        mCommonBaseHttpRequestInterface.requestData(context, Common_HttpPath.URL_API_USER_RULES, params, new Common_ResultDataListener() {
            @Override
            public void onResult(boolean isSucc, String msg, Common_RequestBean request_bean) {
                if(isSucc){
                    ...
                    List<GrabRedEnvelopeModule_Bean_Rule> invoiceBeanList = JSONObject.parseArray(jsonObject.getString("rules"),GrabRedEnvelopeModule_Bean_Rule.class);
     ...
     * 设置投资列表数据
     */
    public  void setInvestmentProductListData(List<GrabRedEnvelopeModule_Bean_Rule> beans){
        if (beans != null) {
