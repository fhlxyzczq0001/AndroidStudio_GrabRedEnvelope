...
import com.ddtkj.grabRedEnvelopeModule.Adapter.GrabRedEnvelopeModule_Adapter_Act_Announcement;
...
import com.ddtkj.grabRedEnvelopeModule.MVP.Presenter.Implement.Activity.GrabRedEnvelopeModule_Act_Announcement_List_Presenter;
 ...
 */
@Route(Common_RouterUrl.GRAB_RED_ENVELOPE_AnnouncementListRouterUrl)
public class GrabRedEnvelopeModule_Act_Announcement_List_View extends UserInfo_BaseActivity<GrabRedEnvelopeModule_Act_Announcement_List_Contract.Presenter,
        GrabRedEnvelopeModule_Act_Announcement_List_Presenter> implements GrabRedEnvelopeModule_Act_Announcement_List_Contract.View  {
    //刷新布局
    ...
    //列表适配器
    private GrabRedEnvelopeModule_Adapter_Act_Announcement mVentureCapital2AdapterFraInvestmentList;
    //项目类型
    String type;
    ...
    protected void setContentView() {
        setContentView(R.layout.grabredenvelopemodule_act_announcement_list_layout);
    }
    ...
    protected void setTitleBar() {
        //设置Actionbar
        setActionbarBar("公告列表", R.color.app_gray, R.color.white, true,false);
    }
     ...
     */
    @Override
    public void setInvestmentProductData(List<GrabRedEnvelopeModule_Bean_Announcement> investmentProductData){
        //设置Adapter
        if (mVentureCapital2AdapterFraInvestmentList == null) {
            mVentureCapital2AdapterFraInvestmentList = new GrabRedEnvelopeModule_Adapter_Act_Announcement(context,investmentProductData);
            ...
            mVentureCapital2AdapterFraInvestmentList.setOnItemClickListener(new OnItemClickListener<GrabRedEnvelopeModule_Bean_Announcement>() {
                ...
                public void onItemClick(View itemView, int viewType, int position, List <GrabRedEnvelopeModule_Bean_Announcement>mData) {
                    ...
                    getIntentTool().intent_RouterTo(context,Common_RouterUrl.GRAB_RED_ENVELOPE_AnnouncementInfoRouterUrl,bundle);
                }
            });
        } else {
