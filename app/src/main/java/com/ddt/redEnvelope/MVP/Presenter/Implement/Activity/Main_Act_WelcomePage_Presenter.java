...
public class Main_Act_WelcomePage_Presenter extends Main_Act_WelcomePage_Contract.Presenter {
    ...
    public Main_Act_WelcomePage_Presenter() {
    ...
    public void requestStartPageUpdate() {
        mPermissionProjectUtilInterface.onePermissions(context, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, new String[]{"SD卡"}, new Permission_ProjectUtil_Implement.PermissionsResultListener() {
            @Override
        ...
        }, false, new Permission_ProjectUtil_Implement.PermissionsDialogCancelListener() {
            @Override
                 ...
                 if (isSucc) {
                     if (request_bean.getData() != null) {
                         ...
                         if (null != share_PageBean) {
                             ...
                             String webFileName = "";
                             if (welcomePageBean.getUrl() != null && !welcomePageBean.getUrl().equals("")) {
                                 webFileName = welcomePageBean.getUrl().substring(start_page_url
                                         .lastIndexOf("/") + 1);
                             }
                             //获取本地文件名
