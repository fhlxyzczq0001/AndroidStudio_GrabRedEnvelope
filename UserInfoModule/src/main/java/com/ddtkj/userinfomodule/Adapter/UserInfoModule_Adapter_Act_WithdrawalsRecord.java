...
public class UserInfoModule_Adapter_Act_WithdrawalsRecord extends SuperAdapter<UserInfoModule_Bean_WithdrawalsRecord> {
    public UserInfoModule_Adapter_Act_WithdrawalsRecord(Context context, List<UserInfoModule_Bean_WithdrawalsRecord> datas) {
        super(context, datas, R.layout.userinfomodule_act_item_withdrawals_record_list_layout);
    }
