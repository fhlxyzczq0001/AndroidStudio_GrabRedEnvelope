...
public class UserInfoModule_Adapter_Act_RedEnvelopeRecord extends SuperAdapter<UserInfoModule_Bean_RedEnvelopeRecord> {
    public UserInfoModule_Adapter_Act_RedEnvelopeRecord(Context context, List<UserInfoModule_Bean_RedEnvelopeRecord> datas) {
        super(context, datas, R.layout.userinfomodule_act_item_red_envelope_record_list_layout);
    }
    ...
    @Override
    public void onBind(final SuperViewHolder holder, int viewType, int layoutPosition, final UserInfoModule_Bean_RedEnvelopeRecord bean) {
