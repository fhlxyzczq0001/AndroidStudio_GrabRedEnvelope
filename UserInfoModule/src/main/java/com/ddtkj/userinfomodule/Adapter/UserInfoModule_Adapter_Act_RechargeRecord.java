...
public class UserInfoModule_Adapter_Act_RechargeRecord extends SuperAdapter<UserInfoModule_Bean_RechargeRecord> {
    public UserInfoModule_Adapter_Act_RechargeRecord(Context context, List<UserInfoModule_Bean_RechargeRecord> datas) {
        super(context, datas, R.layout.userinfomodule_act_item_recharge_record_list_layout);
    }
    ...
    @Override
    public void onBind(final SuperViewHolder holder, int viewType, int layoutPosition, final UserInfoModule_Bean_RechargeRecord bean) {
