...
public class UserInfoModule_Adapter_Act_UserThreedealsRecord extends SuperAdapter<UserInfoModule_Bean_UserThreedealsRecord> {
    public UserInfoModule_Adapter_Act_UserThreedealsRecord(Context context, List<UserInfoModule_Bean_UserThreedealsRecord> datas) {
        super(context, datas, R.layout.userinfomodule_act_item_userthreedeals_record_list_layout);
    }
    ...
    @Override
    public void onBind(final SuperViewHolder holder, int viewType, int layoutPosition, final UserInfoModule_Bean_UserThreedealsRecord bean) {
