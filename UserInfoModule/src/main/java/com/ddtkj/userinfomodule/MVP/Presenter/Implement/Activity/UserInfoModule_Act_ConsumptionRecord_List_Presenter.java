 ...
 */
public class UserInfoModule_Act_ConsumptionRecord_List_Presenter extends UserInfoModule_Act_ConsumptionRecord_List_Contract.Presenter{
    ...
    public UserInfoModule_Act_ConsumptionRecord_List_Presenter(){
    ...
    public void requestInvestmentProductData(String type) {
        ...
        mCommonBaseHttpRequestInterface.requestData(context, Common_HttpPath.URL_API_REDPACKET_CONSUMEMONEY, params, new Common_ResultDataListener() {
            @Override
            public void onResult(boolean isSucc, String msg, Common_RequestBean request_bean) {
                if(isSucc){
                    ...
                    List<UserInfoModule_Bean_ConsumptionRecord> invoiceBeanList = JSONObject.parseArray(jsonObject.getString("consumemoneydetail"),UserInfoModule_Bean_ConsumptionRecord.class);
     ...
     * 设置投资列表数据
     */
    public  void setInvestmentProductListData(List<UserInfoModule_Bean_ConsumptionRecord> beans){
        if (beans != null) {
