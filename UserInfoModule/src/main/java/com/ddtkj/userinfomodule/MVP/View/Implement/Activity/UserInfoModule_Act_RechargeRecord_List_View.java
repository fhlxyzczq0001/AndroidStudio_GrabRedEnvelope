...
import com.ddtkj.userinfomodule.Adapter.UserInfoModule_Adapter_Act_RechargeRecord;
import com.ddtkj.userinfomodule.Base.UserInfo_BaseActivity;
import com.ddtkj.userinfomodule.MVP.Contract.Activity.UserInfoModule_Act_RechargeRecord_List_Contract;
import com.ddtkj.userinfomodule.MVP.Model.Bean.ResponseBean.UserInfoModule_Bean_RechargeRecord;
import com.ddtkj.userinfomodule.MVP.Presenter.Implement.Activity.UserInfoModule_Act_RechargeRecord_List_Presenter;
 ...
 */
@Route(Common_RouterUrl.USERINFO_RechargeRecordRouterUrl)
public class UserInfoModule_Act_RechargeRecord_List_View extends UserInfo_BaseActivity<UserInfoModule_Act_RechargeRecord_List_Contract.Presenter,
        UserInfoModule_Act_RechargeRecord_List_Presenter> implements UserInfoModule_Act_RechargeRecord_List_Contract.View  {
    //刷新布局
    ...
    //列表适配器
    private UserInfoModule_Adapter_Act_RechargeRecord mVentureCapital2AdapterFraInvestmentList;
    //项目类型
    String type;
     ...
     */
    @Override
    public void setInvestmentProductData(List<UserInfoModule_Bean_RechargeRecord> investmentProductData){
        //设置Adapter
        if (mVentureCapital2AdapterFraInvestmentList == null) {
            mVentureCapital2AdapterFraInvestmentList = new UserInfoModule_Adapter_Act_RechargeRecord(context,investmentProductData);
