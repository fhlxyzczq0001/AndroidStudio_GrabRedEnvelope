 ...
 */
public interface UserInfoModule_Act_ConsumptionRecord_List_Contract {
    ...
    interface View extends Common_BaseView {
         ...
         */
        void setInvestmentProductData(List<UserInfoModule_Bean_ConsumptionRecord> investmentProductData);
