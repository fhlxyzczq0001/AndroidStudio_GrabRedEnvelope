 ...
 */
public class UserInfoModule_Act_RechargeRecord_List_Presenter extends UserInfoModule_Act_RechargeRecord_List_Contract.Presenter{
    ...
    public UserInfoModule_Act_RechargeRecord_List_Presenter(){
     ...
     * 设置投资列表数据
     */
    public  void setInvestmentProductListData(List<UserInfoModule_Bean_RechargeRecord> beans){
        if (beans != null) {
