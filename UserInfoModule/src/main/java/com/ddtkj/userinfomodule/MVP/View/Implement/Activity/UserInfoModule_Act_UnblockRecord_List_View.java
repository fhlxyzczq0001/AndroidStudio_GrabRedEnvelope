...
import com.ddtkj.userinfomodule.MVP.Presenter.Implement.Activity.UserInfoModule_Act_UnblockRecord_List_Presenter;
 ...
 */
@Route(Common_RouterUrl.USERINFO_UnblockRecordRouterUrl)
public class UserInfoModule_Act_UnblockRecord_List_View extends UserInfo_BaseActivity<UserInfoModule_Act_UnblockRecord_List_Contract.Presenter,
        UserInfoModule_Act_UnblockRecord_List_Presenter> implements UserInfoModule_Act_UnblockRecord_List_Contract.View  {
    //刷新布局
    ...
    //列表适配器
    private UserInfoModule_Adapter_Act_UnblockRecord mVentureCapital2AdapterFraInvestmentList;
    //项目类型
    String type;
    ...
    protected void setContentView() {
        setContentView(R.layout.userinfomodule_act_unblock_record_list_layout);
    }
    ...
    protected void initMyView() {
        ...
        cetSearch=  findViewById(R.id.cetSearch);
    }
    ...
    protected void setTitleBar() {
        //设置Actionbar
        setActionbarBar("解封账号", R.color.app_gray, R.color.white, true,false);
    }
