 ...
 */
public interface UserInfoModule_Act_WithdrawalsRecord_List_Contract {
    ...
    interface View extends Common_BaseView {
         ...
         */
        void setInvestmentProductData(List<UserInfoModule_Bean_WithdrawalsRecord> investmentProductData);
