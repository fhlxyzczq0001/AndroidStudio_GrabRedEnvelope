 ...
 */
public interface UserInfoModule_Act_UserThreedealsRecord_List_Contract {
    ...
    interface View extends Common_BaseView {
         ...
         */
        void setInvestmentProductData(List<UserInfoModule_Bean_UserThreedealsRecord> investmentProductData);
