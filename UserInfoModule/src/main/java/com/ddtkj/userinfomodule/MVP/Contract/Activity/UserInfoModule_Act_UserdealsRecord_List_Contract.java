 ...
 */
public interface UserInfoModule_Act_UserdealsRecord_List_Contract {
    ...
    interface View extends Common_BaseView {
         ...
         */
        void setInvestmentProductData(List<UserInfoModule_Bean_UserdealsRecord> investmentProductData);
