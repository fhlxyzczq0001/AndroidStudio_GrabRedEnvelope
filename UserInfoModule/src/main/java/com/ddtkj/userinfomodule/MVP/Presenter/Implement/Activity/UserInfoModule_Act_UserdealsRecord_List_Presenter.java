 ...
 */
public class UserInfoModule_Act_UserdealsRecord_List_Presenter extends UserInfoModule_Act_UserdealsRecord_List_Contract.Presenter{
    ...
    public UserInfoModule_Act_UserdealsRecord_List_Presenter(){
    ...
    public void requestInvestmentProductData(String type) {
        ...
        mCommonBaseHttpRequestInterface.requestData(context, Common_HttpPath.URL_API_USER_DEALS, params, new Common_ResultDataListener() {
            @Override
            public void onResult(boolean isSucc, String msg, Common_RequestBean request_bean) {
                if(isSucc){
                    ...
                    UserInfoModule_Bean_UserdealsRecord userInfoModuleBeanUserdealsRecord=JSONObject.parseObject(jsonObject.getString("userdeals"),UserInfoModule_Bean_UserdealsRecord.class);
                    List<UserInfoModule_Bean_UserdealsRecord> invoiceBeanList = new ArrayList<>();
                    invoiceBeanList.add(userInfoModuleBeanUserdealsRecord);
     ...
     * 设置投资列表数据
     */
    public  void setInvestmentProductListData(List<UserInfoModule_Bean_UserdealsRecord> beans){
        if (beans != null) {
