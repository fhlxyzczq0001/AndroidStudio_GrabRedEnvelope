 ...
 * 首页底部导航按钮
 */
public class Common_BottomNavigationViewEx extends BottomNavigationView {
    // used for animation
    ...
    public Common_BottomNavigationViewEx(Context context) {
        super(context);
        init();
    }

    public Common_BottomNavigationViewEx(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public Common_BottomNavigationViewEx(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        System.out.println("mMenuView:" + mMenuView + " mButtons:" + mButtons + " mOnClickListener" + mOnClickListener);
     ...
     * necessary calls back to the provided {@link Common_BottomNavigationViewEx} so that the tab position is
     * kept in sync.
     * <p>
    ...
    private static class BottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<Common_BottomNavigationViewEx> mBnveRef;

        public BottomNavigationViewExOnPageChangeListener(Common_BottomNavigationViewEx bnve) {
        ...
        public void onPageSelected(final int position) {
            final Common_BottomNavigationViewEx bnve = mBnveRef.get();
            if (null != bnve)
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, Common_BottomNavigationViewEx bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
