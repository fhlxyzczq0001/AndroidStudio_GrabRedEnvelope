...
public class Common_CustomDialogBuilder {
    ...
    public NiftyDialogBuilder showDialog(int layout) {
        dialogBuilder
                ...
                .withCloseImage(R.drawable.icon_close_x)
                .withDividerColor(context.getResources().getColor(R.color.app_line_gray))
                .withMessage(null)
     ...
     * @return
     */
    public NiftyDialogBuilder showDialog(View layout) {
        dialogBuilder
                .withTitle(null)
                .withTitleColor(context.getResources().getColor(R.color.black))
                .withCloseImage(R.drawable.icon_close_x)
     ...
     * @return
     */
    public NiftyDialogBuilder showDialog(String title, View layout) {
        dialogBuilder
                .withTitle(title)
                .withTitleColor(context.getResources().getColor(R.color.black))
                .withCloseImage(R.drawable.icon_close_x)
