package com.ddtkj.commonmodule.MVP.View.Implement.PopupWindow;
...
public class Common_PopupWindow_View_Implement implements Common_PopupWindow_View_Interface {
    ...
    public PopupWindow setPopupWindow(Context context, View popupwindowView, PopupWindow popupWindow) {
        ...
        popupWindow.setBackgroundDrawable(context.getResources().getDrawable(R.color.act_dialog_background));
        popupWindow.setOutsideTouchable(true);//设置点击其它地方隐藏弹出框
        // 设置popWindow的显示和消失动画
        popupWindow.setAnimationStyle(R.style.AppCommon_PopwindowSlidebottomAnimStyle);
