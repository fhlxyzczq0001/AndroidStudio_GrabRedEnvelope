package com.ddtkj.commonmodule.MVP.Model.Interface;
...
public interface Common_Base_HttpRequest_Interface {
     ...
     * @param requestMethod 请求类型
     */
    public void requestData(Context context, String URL, Map<String, Object> params, Common_ResultDataListener resultListener, boolean isLoadingDialog, Common_HttpRequestMethod requestMethod, Common_Base_HttpRequest_Implement.SubscriptionResultListener subscriptionResultListener);
    /**
     * 下载文件
