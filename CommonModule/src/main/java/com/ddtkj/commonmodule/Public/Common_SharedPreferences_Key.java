...
public class Common_SharedPreferences_Key {
	public static String APP_Global_SharedPreferences="DdtkjVentureCapital_Global_SharedPreferences";//app全局的SharedPreferences表名

	public static String APP_User_SharedPreferences="DdtkjVentureCapital_User_SharedPreferences";//app用户信息的SharedPreferences表名

	public static String APP_SdCard_SharedPreferences="DdtkjVentureCapital_SdCard_SharedPreferences";//SdCard的SharedPreferences表名
